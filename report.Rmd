...
results <- readRDS(paste0(data_dir,'/',dataset,'/','results.rds'))
#prose <- readRDS(paste0(data_dir,'/',dataset,'/','prose.rds'))
...
```{r, 'reports', message=FALSE, warning=FALSE, results='asis', echo = FALSE, cache = TRUE}
#placenames$word
results
confusion_plot
...
myresults %>%
  ...
  row_spec(1:nrow(myresults),color='black')
```
